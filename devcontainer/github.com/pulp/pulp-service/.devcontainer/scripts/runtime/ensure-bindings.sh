...
# hugging_face omitted: pulp-service removed pulp-hugging-face when bumping to pulpcore 3.115.2
BINDINGS_COMPONENTS=(core python npm rpm maven file service container)
